...
function validateLogin() {
    ...
    // ── Regular user (demo) ───────────────────────────────────────────────────
    // In a real app you'd verify against a backend here.
    // For now, any other valid credentials land on the home page.
    showError(errorEl, 'Invalid credentials. Please try again.');
    return false;
}
